        ...
        if qtype == 'chain-inter':
            ...
            if self.euo:
                ...
                for i in range(2):
                    ...
                    query_center_1 = torch.matmul(query_center_1, relations[i][:, 0, :, :])
                ...
                #query_center_2 = heads[1] + relations[2][:, 0, :, :]
                query_center_2 = torch.matmul(heads[1], relations[2][:, 0, :, :])
            ...
            query_center_1 = torch.matmul(heads[0], relations[0][:, 0, :, :])
            #query_center_2 = heads[1] + relations[1][:, 0, :, :]
            query_center_2 = torch.matmul(heads[1], relations[1][:, 0, :, :])
            ...
            if 'inter' not in qtype and 'union' not in qtype:
                ...
                if 'inter' in qtype:
                    ...
                    if rel_len == 2:
                        new_query_center, new_min, new_max = self.disjoin_nn(queries_center[0], offsets[0], queries_center[1], offsets[1])
                    elif rel_len == 3:
                        new_query_center = self.center_sets(queries_center[0].squeeze(1), offsets[0].squeeze(1),
                                                            queries_center[1].squeeze(1), offsets[1].squeeze(1))
                        new_offset = self.offset_sets(queries_center[0].squeeze(1), offsets[0].squeeze(1),
                        ...
                        new_query_center, new_query_min, new_query_max = self.disjoin_nn(new_query_center, new_offset,
